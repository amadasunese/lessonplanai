...
#         # You would typically check if the email belongs to an admin here, or just set it directly in the DB
#         is_admin = form.email.data == 'amadasunese@yahoo.com'
#         new_user = User(name=form.name.data, sex=form.sex.data, age=form.age.data,
#                         profession=form.profession.data, phone_number=form.phone_number.data,
